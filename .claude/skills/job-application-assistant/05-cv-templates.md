...
**For Content / AI Marketing roles:**
> Marketing professional with end-to-end experience building content systems from scratch — editorial calendar, contributor management, social distribution, and publishing workflow. Authored 20+ AI product analyses reaching 100k+ cumulative reads. Deep AI ecosystem fluency and a track record of converting ad hoc processes into consistent, scalable content engines in fast-moving, cross-functional environments.

**For Investment / VC / Finance roles:**
> Investment analyst with hands-on experience across healthcare investing, synthetic biology diligence, AI/SaaS product analysis, and venture capital investor relations. Skilled in IC-style investment memos, financial modeling (TAM, projections, IRR sensitivity), founder interviews, and decision-ready diligence materials. Strong interest in software-focused private equity and growth equity, with direct exposure to SaaS business models and monetization strategy.

**For AI Product / GTM / Startup roles:**
> AI ecosystem generalist combining product research, go-to-market execution, user research, and community operations. Brings direct early-stage startup experience across fundraising (YC, SkyDeck), BD outreach, user interviewing, and content-led growth — plus a track record of building operational systems from zero. Built a Codex-based automation skill to streamline a content management workflow end-to-end.
